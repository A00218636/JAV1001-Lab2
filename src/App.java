...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        int arrSize = sc.nextInt();
          ...
          System.out.println("Enter characters one by one to reverse an Array: ");
        ...
        System.out.println("Enter size of an Array: ");
         ...
         System.out.println("Enter characters or integers one by one to test CONTAINS operation on an Array: ");
